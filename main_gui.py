...
# import styles
from qtmodernEdited import styles
from qtmodernEdited import windows
...
class MyTable(QTableWidget):
    def __init__(self):
        ...
        # set edit and delete button to be of content length

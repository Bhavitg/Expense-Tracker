...
def light(app):
    ...
    lightPalette.setColor(QPalette.Button, QColor(192, 192, 192))
    lightPalette.setColor(QPalette.Light, QColor(0, 0, 0))
    lightPalette.setColor(QPalette.Midlight, QColor(90, 90, 90))
    ...
    lightPalette.setColor(QPalette.Shadow, QColor(176, 190, 197))
    lightPalette.setColor(QPalette.Highlight, QColor(42, 130, 218))
    lightPalette.setColor(QPalette.HighlightedText, QColor(0, 0, 0))
    lightPalette.setColor(QPalette.Link, QColor(56, 252, 196))
    lightPalette.setColor(QPalette.AlternateBase, QColor(66, 66, 66))
    lightPalette.setColor(QPalette.ToolTipBase, QColor(53, 53, 53))
